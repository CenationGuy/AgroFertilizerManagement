...
<body>
  <nav class="navbar navbar-expand-md bg-dark navbar-dark">
    <!-- Brand -->
    <a class="navbar-brand" href="index.php"><img src="img/logonew.png" width="55px" style="margin-right: 30px;"></a>
          ...
          <table class="table table-bordered table-striped text-center">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td>
                  <input type="number" disabled min=1 oninput="validity.valid||(value='');" class="form-control itemQty"
                ...
                <td>
                  <a href="action.php?remove=<?= $row['p_id'] ?>" class="text-danger lead"
              ...
              <tr>
                <td colspan="3">
                  <a href="welcome.php" class="btn btn-success"><i class="fas fa-cart-plus"></i>&nbsp;&nbsp;Continue
                    Shopping</a>
                </td>
